...
class PaymentWebhookController extends Controller
{
    ...
    public function transbankReturn(Request $request)
    {
        try {
            ...
            Log::debug('Transbank: Procesando retorno', ['token' => $this->maskToken((string) $token)]);
    ...
    public function mercadopagoWebhook(Request $request)
    {
        try {
            ...
            Log::debug('MercadoPago: Webhook recibido', $this->summarizeMercadoPagoWebhook($request));
