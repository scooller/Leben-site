                                ...
                                Section::make('Optimización para Motores de Búsqueda')
                                    ->schema([
                                        ...
                                        TextInput::make('extra_settings.utm_source_default')
                                            ...
                                            ->default('direct')
                                            ->maxLength(100)
                                            ->helperText('Valor por defecto para utm_source cuando no llega en la URL (ej: direct).'),

                                        TextInput::make('extra_settings.utm_medium_default')
                                            ->label('UTM Medium por defecto')
                                            ->default('organic')
                                            ->maxLength(100)
                                            ->helperText('Valor por defecto para utm_medium cuando no llega en la URL (ej: organic).'),

                                        TextInput::make('extra_settings.utm_term_default')
                                            ->label('UTM Term por defecto')
                                            ->default('none')
                                            ->maxLength(100)
                                            ->helperText('Valor por defecto para utm_term cuando no llega en la URL (ej: none).'),

                                        TextInput::make('extra_settings.utm_content_default')
                                            ->label('UTM Content por defecto')
                                            ->default('none')
                                            ->maxLength(100)
                                            ->helperText('Valor por defecto para utm_content cuando no llega en la URL (ej: none).'),

                                        TextInput::make('extra_settings.utm_site_default')
                                            ->label('UTM Site por defecto')
                                            ->maxLength(255)
                                            ->helperText('Valor por defecto para utm_site. Si está vacío, el frontend usa el hostname actual.'),
