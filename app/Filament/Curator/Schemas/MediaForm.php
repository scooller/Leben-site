                            ...
                            ->tabs([
                                ...
                                Tab::make(trans('curator::forms.sections.curation'))
                                    ->visible(function ($record): bool {
                                        /** @var CuratorPlugin $curatorPlugin */
                                        $curatorPlugin = CuratorPlugin::get();

                                        return is_media_resizable($record->ext) && $curatorPlugin->supportsCurations();
                                    })
                                    ->schema([
                                ...
                                Tab::make(trans('curator::forms.sections.replace'))
                                    ->visible(function (): bool {
                                        ...
                                        return $curatorPlugin->supportsFileSwap();
                                    })
                                    ->schema([
                                        App::make(config('curator.resource.schemas.form'))::getUploaderField()
