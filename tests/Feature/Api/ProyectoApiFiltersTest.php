...
class ProyectoApiFiltersTest extends TestCase
{
    ...
    public function test_it_uses_default_field_projection_when_campos_is_missing(): void
    {
        ...
        $this->assertSame(['id', 'name', 'direccion', 'comuna', 'pagina_web', 'etapa', 'entrega_inmediata', 'telefono', 'horario_atencion', 'salesforce_logo_url', 'salesforce_portada_url', 'descuento_defecto_cotizacion_web', 'descuento_maximo_unidad', 'project_image_id', 'precio_desde', 'tipologias'], array_keys($item));
