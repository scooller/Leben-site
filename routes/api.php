    ...
    Route::get('/', function () {
        return response()->json([
            ...
            'tags' => [
                ...
                ['name' => 'Brokers', 'description' => 'Catálogo público de brokers, alianzas, eventos y galerías'],
            ...
            'paths' => [
                ...
                '/brokers' => ['get' => ['tags' => ['Brokers'], 'operationId' => 'listBrokers', 'summary' => 'Listado de brokers activos', 'security' => [['bearerAuth' => []]], 'parameters' => [['name' => 'category', 'in' => 'query', 'required' => false, 'schema' => ['type' => 'string'], 'description' => 'Slug de la categoría del broker']], 'responses' => ['200' => ['description' => 'Listado de brokers'], '401' => ['description' => 'No autenticado']]]],
                '/brokers/{broker}/alliances' => ['get' => ['tags' => ['Brokers'], 'operationId' => 'listBrokerAlliances', 'summary' => 'Listado de alianzas activas del broker', 'security' => [['bearerAuth' => []]], 'parameters' => [['$ref' => '#/components/parameters/BrokerId']], 'responses' => ['200' => ['description' => 'Listado de alianzas'], '401' => ['description' => 'No autenticado'], '404' => ['description' => 'No encontrado']]]],
                '/brokers/{broker}/events' => ['get' => ['tags' => ['Brokers'], 'operationId' => 'listBrokerEvents', 'summary' => 'Listado de eventos publicados del broker', 'security' => [['bearerAuth' => []]], 'parameters' => [['$ref' => '#/components/parameters/BrokerId'], ['name' => 'from', 'in' => 'query', 'required' => false, 'schema' => ['type' => 'string', 'format' => 'date'], 'description' => 'Fecha mínima de inicio'], ['name' => 'to', 'in' => 'query', 'required' => false, 'schema' => ['type' => 'string', 'format' => 'date'], 'description' => 'Fecha máxima de inicio']], 'responses' => ['200' => ['description' => 'Listado de eventos'], '401' => ['description' => 'No autenticado'], '404' => ['description' => 'No encontrado']]]],
                '/brokers/{broker}/galleries' => ['get' => ['tags' => ['Brokers'], 'operationId' => 'listBrokerGalleries', 'summary' => 'Listado de galerías publicadas del broker', 'security' => [['bearerAuth' => []]], 'parameters' => [['$ref' => '#/components/parameters/BrokerId'], ['name' => 'year', 'in' => 'query', 'required' => false, 'schema' => ['type' => 'integer'], 'description' => 'Año de la galería'], ['name' => 'month', 'in' => 'query', 'required' => false, 'schema' => ['type' => 'integer'], 'description' => 'Mes de la galería']], 'responses' => ['200' => ['description' => 'Listado de galerías'], '401' => ['description' => 'No autenticado'], '404' => ['description' => 'No encontrado']]]],
                '/brokers/{broker}/galleries/{gallery}' => ['get' => ['tags' => ['Brokers'], 'operationId' => 'getBrokerGallery', 'summary' => 'Detalle de galería del broker', 'security' => [['bearerAuth' => []]], 'parameters' => [['$ref' => '#/components/parameters/BrokerId'], ['$ref' => '#/components/parameters/GalleryId']], 'responses' => ['200' => ['description' => 'Detalle de galería'], '401' => ['description' => 'No autenticado'], '404' => ['description' => 'No encontrado']]]],
